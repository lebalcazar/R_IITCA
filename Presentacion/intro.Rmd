...
Vuelva al código donde se creó la matriz y observe que para asignar el resultado de un proceso a una variable se utiliza los signos `<-` (menor que y guión, sin espacios). Veamos otro ejemplo, para asignar un vector de 4 números aleatorios al objeto `a`, se escribe de la siguiente manera:
