...
date: "Toluca, México, diciembre de 2020"
output: pdf_document
urlcolor: blue
citecolor: blue
linkcolor: blue
...
Los datos para el taller se encuentran en un repositorio de  [GitHub](https://github.com/lebalcazar/R_IITCA.git) (estará disponible minutos antes del taller). Es recomendable que usted tenga otro dispositivo a parte de su computador para ver la presentación y realizar los ejercicios en la máquina que tiene R. Además, descargar estos [datos](https://www.dropbox.com/s/tkkqyz2kaqoh4cj/DEM_Senegal.7z?dl=0). 
